...
const labels = { dodge: "躲避类", collect: "接金币类", maze: "迷宫类", snake: "贪吃蛇", "2048": "2048" };
export const visualThemeLabels: Record<VisualTheme, string> = { space: "太空", ocean: "海洋", lava: "熔岩", ice: "冰雪", forest: "森林", neon: "霓虹", desert: "沙漠" };
const templates: [GameSpec["genre"], string][] = [["dodge", "星际闪避"], ["collect", "接金币"], ["maze", "迷你迷宫"], ["snake", "贪吃蛇"], ["2048", "经典 2048"]];
